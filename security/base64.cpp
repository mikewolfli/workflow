 ...
 *
 * $Revision: 5546 $
 * $Id: base64.cpp 5546 2009-04-27 15:46:48Z biplab $
 * $HeadURL: svn+ssh://jenslody@svn.berlios.de/svnroot/repos/codeblocks/trunk/src/sdk/base64.cpp $
 */
...
wxString Base64::Encode(const wxString& data)
{
    return Base64::Encode((const wxUint8*)data.c_str(), data.Length());
}

wxString Base64::Encode(const wxUint8* pData, size_t len)
{
    size_t c;
    wxString ret;
...
wxString Base64::Decode(const wxString& data)
{
    int c;
    int c1;
